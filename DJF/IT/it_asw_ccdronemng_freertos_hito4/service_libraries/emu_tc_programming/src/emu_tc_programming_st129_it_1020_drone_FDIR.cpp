...
// Step 0: añade la definición de monitor para UAH_DRONE_Wind con PMONID=0.
// Si wind > FDIR_WIND_UINT32_LIMIT, se dispara el evento 0x4002.
...
// Step 1: añade la event-action: evento 0x4002 -> ejecuta TC[129,4] (Abort Flight Plan).
EmuGSS_TCProgram19_1_Action_129_4 prog_FT_1020_step_1(FT_1020_TIME_step1,
    "IT_UAH_DRONE_FDIR_1020 step 1, Event 0x4002 Action is Abort Flight",
    0x4002);

// Step 2: habilita la event-action del evento 0x4002.
EmuGSS_TCProgram19_4 prog_FT_1020_step_2(FT_1020_TIME_step2,
    "IT_UAH_DRONE_FDIR_1020 step 2, 0x4002 Action enabled",
    0x4002);

// Step 3: habilita la definición de monitor (PMONID 0).
EmuGSS_TCProgram12_1 prog_FT_1020_step_3(FT_1020_TIME_step3,
    "IT_UAH_DRONE_FDIR_1020 step 3, Enable Monitoring PMODID 0",
    0);

// Step 4: configura los parámetros del PID.
EmuGSS_TCProgram129_2 prog_FT_1020_step_4(FT_1020_TIME_step4,
    "IT_UAH_DRONE_FDIR_1020 step 4, Set PID Params to 0.2, 0.15, 0.05",
    0.2, 0.15, 0.05);

// Step 5: carga el plan de vuelo.
EmuGSS_TCProgram129_1 prog_FT_1020_step_5(FT_1020_TIME_step5,
    "IT_UAH_DRONE_FDIR_1020 step 5, Set Flight Plan X=150.5, Y=90.5, Z=30.2",
    150.5, 90.5, 30.2);

// Step 6: ejecuta el plan de vuelo.
